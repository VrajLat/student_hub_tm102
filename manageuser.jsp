                        ...
                        <table id="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><img src="../upload/<%= rs.getString("profile_picture") %>" alt="Post Image" style="max-width: 50px; max-height: 50px;"></td>
                                    <td><a href="edituser2.jsp?id=<%= rs.getInt("user_id")%>"><button type="button" class="btn btn-success btn-block">Edit</button></a></td>
                                    <td><a href="deleteuser.jsp?id=<%= rs.getInt("user_id")%>"><button type="button" class="btn btn-warning btn-block">Delete</button></a></td>
                                </tr>
                            </tbody>
                            <%
                                }
