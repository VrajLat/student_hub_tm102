...
<html>
    <head>
        ...
        <link href="images/bus.png" rel="icon" alt="Student_Hub">
    ...
    <jsp:include page="header.jsp" />
        ...
        <main>
            ...
            <div class="cards">
                ...
                <div class="card-single">
                    ...
                    try {
                        ...
                        ResultSet rs = stmt.executeQuery("SELECT COUNT(*) AS totalUsers FROM users");

                        // Check if the result set contains any rows
                        if (rs.next()) {
                            // Retrieve the total number of users from the result set
            ...
            %>
            <span style="font-size: 20px;">Total User : <%= totalUsers %></span>
                ...
                try {
                    ...
                    ResultSet rs = stmt.executeQuery("SELECT COUNT(*) AS totalPost FROM posts");

                    // Check if the result set contains any rows
                    if (rs.next()) {
                        // Retrieve the total number of posts from the result set
    ...
    %>
                        <span style="font-size: 20px;">Total Post : <%= totalPost %></span>
                ...
                <div class="card-single">
                    ...
                    try {
                       // Create a statement to execute the SQL query
                            ...
                            // Execute the query to get the total count of feedback
                            ResultSet rs = stmt.executeQuery("SELECT COUNT(*) AS totalFeedback FROM feedback");

                            // Check if the result set contains any rows
                            if (rs.next()) {
                                // Retrieve the total number of feedback from the result set
                        ...
                        <span style="font-size: 20px;">Total Feedback : <%= totalFeedback %></span>
