    ...
    <body>
        ...
        <div class="main-content">
                ...
                <%
                    ...
                    try {
                        ...
                        if (rs.next()) {
                            ...
                            String enrolmentNo = rs.getString("enrolment_no");
                        ...
                        <div class="col-md-12">
                            <form action="edituser.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control form-input" id="bio" name="bio" rows="3" placeholder="Enter Bio"><%= bio%></textarea>
                                    </div>
                                </div>
            ...
            <!--    <form action="" method="post">
                    ...
                    <input type="text" id="enrolmentNo" name="enrolmentNo" ><br>
                    <label for="department">Department:</label>
                    <input type="text" id="department" name="department" value="<%= department%>"><br>
                    <label for="semester">Semester:</label>
                    <input type="text" id="semester" name="semester" value="<%= semester%>"><br>
