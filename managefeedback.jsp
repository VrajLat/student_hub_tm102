        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="managefeedback.jsp" class="active" ><span class="las la-comments"></span>
        ...
        <div class="main-content">
            ...
            <main>
                <div class="custom-link">
                    ...
                    <i class="fa fa-angle-right"></i> &nbsp;<span style="color: red;"><b>Manage Feedback</b></span>
                </div>
                <%
                    Connection con = MyConnection.getConnection();

                    PreparedStatement pr = con.prepareStatement("select * from feedback");
                ...
                <div class="agile-tables">
                    <div class="table-container">
                        <table id="table">
                            <thead>
                                <tr>
                                    <th colspan="4" style="background-color: #fff; vertical-align: middle; text-transform: capitalize; padding: 20px;">
                                        <h2 class="heading d-flex align-items-center justify-content-between">
                                            <b><span class="heading-text">Feedback</span></b>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="deletefeedback.jsp?id=<%= rs.getInt("feedback_id")%>"><button type="button" class="btn btn-success btn-block">Delete</button></a></td>
